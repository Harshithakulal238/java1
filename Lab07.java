...
public class Lab07 {
    public static void main(String[] args){
        String title0="Lab 07 program-Resizable Interface";
        ...
        String title2="Create a class Rectangle that implements and Resizable interface and implements the resize methods. ";
